...
// Using React.forwardRef to accept a ref in ProjectCard
const ProjectCard = React.forwardRef<HTMLDivElement, ProjectCardProps>(
    ({project, className, ...props}, ref) => {

        const {current: backgroundPattern} = useRef(randomBackgroundPattern());
            ...
            >
                {
                    ...
                    <div
                        className={cn(
                            "-z-50 absolute bottom-0 inset-0 pointer-events-none top-0",
                            backgroundPattern,
                        )}></div>
                }
                <div
